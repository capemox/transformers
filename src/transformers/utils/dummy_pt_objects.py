...
class NeoBertForMaskedLM(metaclass=DummyObject):
    _backends = ["torch"]
...
class NeoBertForSequenceClassification(metaclass=DummyObject):
    _backends = ["torch"]
...
class NeoBertModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class NeoBertPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
